...
class RegexUtil {
  ...
  ///Return whether input matches regex of PassWord.
    ...
    if (isIDCard18(input)) {
      ...
      if (cityMap.isEmpty) {
        ...
        for (var i = 0, length = list.length; i < length; i++) {
          ...
          var mapEntry = MapEntry<String, String>(tokens[0], tokens[1]);
      ...
      if (cityMap[input.substring(0, 2)] != null) {
        ...
        var idCardMod = weightSum % 11;
        var idCardLast = String.fromCharCode(input.codeUnitAt(17));
